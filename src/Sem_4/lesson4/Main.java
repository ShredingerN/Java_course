...
//        arrayVsLinkedLists();
        ...
        Scanner sc = new Scanner(System.in); // стандартный сканер нет необходимости закрывать
    ...
    private static long timer(List<Integer> list) {
        ...
        for (int i = 0; i < 200_000; i++) {
            list.add(0, 1); //ll работает быстрее при вставке в начало
//            list.add(i); //ll тоже быстрее при большом количестве элементов
        }
        long end = System.currentTimeMillis();
        return end - start; // столько милисекунд заняло выполнение куска кода
    }
